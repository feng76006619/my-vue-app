  ...
  <div id="write" class="">
    ...
    <p>
      <span>高速图片加速需要</span><strong><span>加速码</span></strong><span>来提供加速时间，可前往</span><a
        href="https://mall.pixivic.net/product/"
        target="_blank"
        class="url"
      >https://mall.pixivic.net/product/</a><span>购买加速码，选择你想要的时长，点击购买</span>
    </p>
    <p>
      <img
    ...
    <p>
      <span>输入你的邮箱地址（很</span><strong><code>重要</code></strong><span>，会发送兑换码到输入的邮箱）与查询密码（输入你熟悉的）后，点击立即购买</span>
    </p>
    <p>
      <img
    ...
    <p>
      <span>扫码付款即可，付款成功后不出意外将会出现下面的界面（如果因为太长时间没扫不出现也没关系，兑换码会发到邮箱中）</span>
    </p>
    <p>
      <img
    ...
    <p><span>兑换完成后访问画作详情页体验变化</span></p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
